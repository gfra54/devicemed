		...
		<h2 class="title">Les fournisseurs des fabricants de dispositifs médicaux</h2>
					...
					<?php foreach($fournisseurs as $fournisseur) {?>
								...
								<?php if(get_field('premium',$fournisseur->ID)) {?>
									<div class='supplier_search'><a href="<?php echo get_permalink($fournisseur);?>" target='_blank'><b><?php echo $fournisseur->post_title;?></b></a></div>
								<?php }else {?>
									<div class='supplier_search'><a href="<?php echo get_permalink($fournisseur);?>" target='_blank'><?php echo $fournisseur->post_title;?></a></div>
								<?php }?>
