...
<div class="row column-content page-members">
	...
	<section class="results">
			<h2 class="title">Fournisseurs dans la catégorie <?php echo esc_html($category['supplier_category_title']); ?></h2>
<?php if(count($suppliers) > 0) { ?>
	...
	<?php endforeach; ?>
<?php }else { ?>
				<div class='aucun_fournisseurs'>Aucun fournisseur trouvé.</div>
<?php } ?>
...
<!-- FOOTER -->
	...
	<div id="sidebar" class="column col-md-3 col-sm-4 column-sidebar">
		...
		<!--<section id="sidebar-issues">
			<header>
				<div class="left-side">
					<img src="<?php echo get_template_directory_uri(); ?>/images/sidebar-issues-icon.png" />
				</div>
				<div class="right-side">
