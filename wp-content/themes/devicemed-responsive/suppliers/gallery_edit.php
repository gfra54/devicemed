...
<?php } ?>
<div class="row column-content page-suppliers page-suppliers-Galeries page-suppliers-Galeries-edit">
	<div class="col-md-9 col-sm-8 column-main">
		<section>
			<h2 class="title"><?php echo $data['ID'] ? 'Modifier galerie' : 'Ajouter galerie'; ?></h2>
			<div class="form-fieldset">
				<form method="post">
					<div class="form-row form-row-title">
						<div class="form-label"><label for="supplier_gallery_title">Titre de la galerie</label></div>
						<div class="form-field"><input type="text" id="supplier_gallery_title" name="supplier_gallery_title" value="<?php echo esc_attr($data['supplier_gallery_title']); ?>" placeholder="Titre de la galerie" /></div>
						<div class="form-message"><?php if (!empty($errors['supplier_gallery_title'])): ?><div class="form-error"><?php echo $errors['supplier_gallery_title']; ?></div><?php endif; ?></div>
					</div>
					<div class="form-row">
...
<?php foreach ($data['supplier_gallery_uploaded_files'] as $file): ?>
	<div class="uploaded-file">
		<input type="hidden" name="supplier_gallery_uploaded_files[]" value="<?php echo esc_attr($file); ?>" />
...
<?php endforeach; ?>
							...
							<div class="form-message"><?php if (!empty($errors['supplier_gallery_files'])): ?><div class="form-error"><?php echo $errors['supplier_gallery_files']; ?></div><?php endif; ?></div>
						</div>
					</div>
					<div class="form-submit"><input type="submit" value="<?php if ($data['ID']): ?>Modifier galerie<?php else: ?>Ajouter galerie<?php endif; ?>" /></div>
				</form>
			</div>
		</section>
	</div><!-- .column-main -->
