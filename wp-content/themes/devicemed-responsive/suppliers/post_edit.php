...
<?php } ?>
<div class="row column-content page-suppliers page-suppliers-posts page-suppliers-posts-edit">
	<div class="col-md-9 col-sm-8 column-main">
		<section>
			<h2 class="title"><?php echo $data['ID'] ? 'Modifier un article' : 'Ajouter un article'; ?></h2>
			<div class="form-fieldset">
				<form method="post">
					<div class="form-row form-row-title">
						<div class="form-label"><label for="supplier_post_title">Titre de l'article</label></div>
						<div class="form-field"><input type="text" id="supplier_post_title" name="supplier_post_title" value="<?php echo esc_attr($data['supplier_post_title']); ?>" placeholder="Titre de votre article" /></div>
						<div class="form-message"><?php if (!empty($errors['supplier_post_title'])): ?><div class="form-error"><?php echo $errors['supplier_post_title']; ?></div><?php endif; ?></div>
					</div>
					<div class="form-row form-row-content">
						<div class="form-label"><label for="supplier_post_content">Contenu de l'article</label></div>
						<div class="form-field"><textarea class="editable" name="supplier_post_content"><?php echo $data['supplier_post_content']; ?></textarea></div>
						<div class="form-message"><?php if (!empty($errors['supplier_post_content'])): ?><div class="form-error"><?php echo $errors['supplier_post_content']; ?></div><?php endif; ?></div>
					</div>
					<div class="form-row">
...
<?php endforeach; ?>
					...
					<div class="form-submit"><input type="submit" value="<?php if ($data['ID']): ?>Modifier article<?php else: ?>Ajouter article<?php endif; ?>" /></div>
				</form>
			</div>
		</section>
	</div><!-- .column-main -->
