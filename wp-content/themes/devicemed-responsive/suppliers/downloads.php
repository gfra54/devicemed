...
<?php foreach ($downloads as $download): ?>
		<article>
			<div class='icone_acrobat'><a href='<?php echo esc_attr(DM_Wordpress_Suppliers_Download::get_pdf_url($download['ID'], $download['supplier_download_pdf'])); ?>' target='_blank'><img src='http://www.devicemed.fr/wp-content/uploads/icones_acrobat.png' /></a></div>
			<div class="right">
				<header>
