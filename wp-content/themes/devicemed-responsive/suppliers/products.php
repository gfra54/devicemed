			...
			if($categorieId != '') {
				...
				for($i = 0; $i < sizeOf($tabCategories); $i++) {
					...
					if($nomCategorie != '' && $nomCategorieParent != '') {
						echo "<a href='http://www.devicemed.fr/suppliers/?categorie=$categorieParentId' target='_blank'>$nomCategorieParent</a> >";

						if($sousCategorieParent != 0) {
							echo " <a href='http://www.devicemed.fr/suppliers/?souscat=$sousCategorieParent' target='_blank'>$nomsousCategorieParent</a> >";
						}

						echo " <a href='http://www.devicemed.fr/suppliers/?categorie=$idCategorie' target='_blank'>$nomCategorie</a><br />";
					}
				}
			}else {
