...
<head>
	...
	<link href="<?php bloginfo('stylesheet_directory'); ?>/js/fancybox/jquery.fancybox.css" rel="stylesheet">
	...
	<script src="<?php bloginfo('stylesheet_directory'); ?>/js/fancybox/jquery.fancybox.js"></script>
	<script src="<?php bloginfo('stylesheet_directory'); ?>/js/fancybox/jquery.fancybox.pack.js"></script>
	<script>
...
<?php endforeach; ?>
	...
	<section class="medias">
		...
		<div class="Videos-wrapper">
			...
			?>
					<a href='<?php echo "http://www.devicemed.fr/posts/details/video/". $video['ID'] ."?supplier_id=$supplier_id"; ?>'><article>
