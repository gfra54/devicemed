$(document).ready(function(){
	...
	$('body').on('keyup','#terme',function(){
		recherche_rapide($(this).val());
	});
})

function recherche_rapide(_val) {
	_val = accent_fold(_val).toLowerCase();
	$('.supplier_search A').each(function(){
		_text = strip(accent_fold($(this).html()).toLowerCase());
	...
	$('.lettre-groupe').each(function(){
		if($(this).find('.supplier_search A:not(.hide)').length==0) {
			$(this).addClass('hide');
		} else {
			$(this).removeClass('hide');
		}
