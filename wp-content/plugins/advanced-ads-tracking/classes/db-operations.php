...
class Advanced_Ads_Tracking_Dbop {
	...
	private function __construct() {
		...
		$this->warnings = array(
			'row-oversize' => sprintf( __( 'One of the tracking tables has more than %1$s entries. Please go to the <a href="%2$s">database management page</a> to compress it.', 'advanced-ads-tracking' ),
