...
/*		setInterval(function(){
		...
		if($('#wp-admin-bar-view .ab-item').length) {
			if($('#wp-admin-bar-view .ab-item').html().indexOf('Newsletter')>0) {
				...
				$('<li><a href="'+$('#wp-admin-bar-view .ab-item').attr('href').replace('http:','https:')+'?source=true&TB_iframe=false&width=900&height=958" title="Code source" class="thickbox ab-item">Code source de la newsletter</a></li>').insertAfter('#wp-admin-bar-view');
