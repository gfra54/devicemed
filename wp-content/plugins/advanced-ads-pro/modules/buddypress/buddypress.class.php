...
class Advanced_Ads_Pro_Module_BuddyPress {
	...
	public function visitor_conditions( $conditions ){
		...
		$conditions['buddypress_profile_field'] = array(
			...
			'passive_info' => array( 'hash_fields' => 'field', 'remove' => 'login', 'function' => array( 'Advanced_Ads_Pro_Module_BuddyPress', 'get_passive' ) )
		);
	 ...
	 */
	static function get_passive( $options = array() ) {
